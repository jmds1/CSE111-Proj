...
--#13 Find which users have made more than 2 searches in the past 5 days where at least two of them were for plants of species Vascular plant. 
SELECT search_username
FROM search 
WHERE search_daysAgo <= 5
